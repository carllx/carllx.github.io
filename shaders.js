...
AFRAME.registerShader('three_stand_shader', {
  schema: {
  ...
  init: function (data) {
    ...
    if (data.roughnessMap) { AFRAME.utils.material.updateDistortionMap('roughness', this, data); }
...
function getMaterialData (data) {
  ...
  if (data.roughnessMap) { newData.roughness = data.roughness; }
